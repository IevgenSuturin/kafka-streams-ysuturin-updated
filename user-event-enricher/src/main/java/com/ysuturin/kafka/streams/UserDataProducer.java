...
public class UserDataProducer {
    ...
    public static void main(String[] args) throws InterruptedException, ExecutionException {
        ...
        //FLY - We do .get() to ensure the writes to the topics are sequential. for the sake of the teaching exercise
        //DO NOT DO THIS IN PRODUCTION OR IN ANY PRODUCES. BLOCKING IN FUTURE IS BAD!!!!!

        // we are going to test different scenario to illustrate the join
        ...
        // 3 - we update user "john", and sent new transaction
